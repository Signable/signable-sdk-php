...
class Envelopes {
     ...
     * @param int     $autoRemind        optional - Hours for Signable to automatically remind the active signer. Must be greater than 12
     * @param int     $autoExpire        optional - Hours for Signable to automatically expire the envelope. Must be greater than 12
     * @param string  $meta              optional - JSON string containing any additional information to be stored
     *
