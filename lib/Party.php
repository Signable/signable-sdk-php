...
class Party {
     ...
     * @param bool   $inPersonSigning (optional) true if this party should sign in-person, default false.
     */
    public function __construct( $partyName, $partyEmail, $partyID, $partyMessage = '',  $haveTemplate = 'yes', $inPersonSigning = false ) {

        $this->party_name              = $partyName;
        $this->party_email             = $partyEmail;
        $this->party_message           = $partyMessage;
        $this->signature_in_person = $inPersonSigning;
